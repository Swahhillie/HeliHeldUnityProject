...
public abstract class MissionObjectBase : MonoBehaviour {
	...
	public void OnTriggered(string eventName, TriggerType triggerType){
		Debug.Log(name + " trigger was activated by " + triggerType + " with event " + eventName);
	}
/*	
