...
public class LevelSaverEditor : EditorWindow
{
	...
	private enum SavingTarget
	{
		Level,
		Menu
	}
	private static SavingTarget target;
	...
	private void OnSelectionChange ()
	{
		...
		} else if (target == SavingTarget.Menu) {
